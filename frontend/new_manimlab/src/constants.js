...
export const MODULE_URL = 'http://eulertour.com:8000/api/modules/';
export const GET_FILES_URL = 'http://eulertour.com:8000/api/files/';
export const SESSION_URL = 'http://eulertour.com:8000/api/session/';
